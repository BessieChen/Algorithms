...
int main() {
    ...
    int a10[] = {8,7,6,5,4,3,2,1};
    int* arr5 = SortTestHelper::copyIntArray(a10, 8);
//    int* arr6 = SortTestHelper::copyIntArray(arr1, n);
    
    int* arr6 = SortTestHelper::copyIntArray(a10, 8);
    ...
    SortTestHelper::testSort("Heap Sort 1", heapSort1, arr5, 8);
